...
<div class="container search-bar mt-4">
  <div class="row g-3">
    <div class="col-md-5">
      <input type="text" class="form-control" placeholder="Nhập từ khóa (VD: Kế toán, IT...)">
    </div>
    <div class="col-md-5">
      <input type="text" class="form-control" placeholder="Địa điểm (VD: TP.HCM, Hà Nội...)">
    </div>
    <div class="col-md-2">
      <button class="btn btn-primary w-100">Tìm việc ngay</button>
    </div>
  </div>
</div>
  ...
  <div class="job-list">
    <?php while($row = mysqli_fetch_assoc($result)) { ?>
      <div class="job-card">
        ...
        <a href="job_detail.php?id=<?php echo $row['id']; ?>">Xem chi tiết</a>
      </div>
    <?php } ?>
  </div>
</div>
